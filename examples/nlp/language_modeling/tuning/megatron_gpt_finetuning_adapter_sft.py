...
from nemo.collections.nlp.models.language_modeling.megatron_gpt_finetune_adp_model import MegatronGPTAdapterFT
...
def main(cfg) -> None:
    ...
    with open_dict(gpt_model_cfg):
        ...
        gpt_model_cfg.language_model_path = cfg.model.language_model_path
        gpt_model_cfg.virtual_prompt_style = 'no-prompts'


    model = MegatronGPTAdapterFT.restore_from(
